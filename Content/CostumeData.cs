...
internal class CostumeData
{
    ...
    internal List<Tuple<string, Object, Dictionary<string, string>>> CustomObjects { get; set; } = new();

    internal int Count => this.CustomObjects.Count;

    internal void AddCustomObject(string name, Object obj, Dictionary<string, string> meta)
    {
        ...
        this.CustomObjects.Add(new Tuple<string, Object, Dictionary<string, string>>(name, obj, meta));
    }
}