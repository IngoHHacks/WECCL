...
{
    private static bool _uncolor = false;
    ...
    public static bool Scene_Loading_Update(Scene_Loading __instance)
    {
        if (_text == null)
        {
            var parent = __instance.gLoader.transform.parent;
            var go = new GameObject("LoadingText", typeof(Text));
            ...
            var go2 = new GameObject("LoadingTextSub", typeof(Text));
