...
namespace WECCL.Patches
{
    ...
    internal class ContentPatch
    {
        ...
        public static void GameTextures_CGHJPFMGCAO()
        {
            ...
            {
                GameTextures.CEJEFCFAEOB[GameTextures.AAIJMJLPAFC] += CustomCostumes["face_male"].Count; // Unknown (default face_male)
                CustomContentSaveFile.ContentMap.MaterialNameMap[GameTextures.AAIJMJLPAFC].AddRange(CustomCostumes["face_male"].CustomObjects.Select(c => c.Item1));
                GameTextures.BJOHIDFGJJL[GameTextures.AAIJMJLPAFC] += 0; // face_flesh2 (default face_flesh)
                GameTextures.EBIAAOEBLLB[GameTextures.AAIJMJLPAFC] += CustomCostumes["face_shape"].Count; // Unknown (default face shapes)
                CustomContentSaveFile.ContentMap.ShapeNameMap[GameTextures.AAIJMJLPAFC].AddRange(CustomCostumes["face_shape"].CustomObjects.Select(c => c.Item1));
            }
            for (GameTextures.AAIJMJLPAFC = 8; GameTextures.AAIJMJLPAFC <= 12; GameTextures.AAIJMJLPAFC++)
            {
                if (GameTextures.AAIJMJLPAFC != 10)
                {
                    _internalCostumeCounts[CustomCostumes["arms_material"].InternalPrefix] = GameTextures.CEJEFCFAEOB[GameTextures.AAIJMJLPAFC];
                    GameTextures.CEJEFCFAEOB[GameTextures.AAIJMJLPAFC] += CustomCostumes["arms_material"].Count;
                    CustomContentSaveFile.ContentMap.MaterialNameMap[GameTextures.AAIJMJLPAFC].AddRange(CustomCostumes["arms_material"].CustomObjects.Select(c => c.Item1));
                    _internalCostumeCounts[CustomCostumes["arms_flesh"].InternalPrefix] = GameTextures.BJOHIDFGJJL[GameTextures.AAIJMJLPAFC];
                    GameTextures.BJOHIDFGJJL[GameTextures.AAIJMJLPAFC] += CustomCostumes["arms_flesh"].Count;
                    CustomContentSaveFile.ContentMap.FleshNameMap[GameTextures.AAIJMJLPAFC].AddRange(CustomCostumes["arms_flesh"].CustomObjects.Select(c => c.Item1));
                    _internalCostumeCounts[CustomCostumes["arms_shape"].InternalPrefix] = GameTextures.EBIAAOEBLLB[GameTextures.AAIJMJLPAFC];
                    GameTextures.EBIAAOEBLLB[GameTextures.AAIJMJLPAFC] += CustomCostumes["arms_shape"].Count;
                    CustomContentSaveFile.ContentMap.ShapeNameMap[GameTextures.AAIJMJLPAFC].AddRange(CustomCostumes["arms_shape"].CustomObjects.Select(c => c.Item1));
                }
            }
