...
internal class ContentPatch
{
    ...
    public static void GameTextures_CGHJPFMGCAO()
    {
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[1]
        ...
        CustomContentSaveFile.ContentMap.FleshNameMap[1]
        ...
        CustomContentSaveFile.ContentMap.ShapeNameMap[1]
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[2]
        ...
        CustomContentSaveFile.ContentMap.FleshNameMap[2]
        ...
        CustomContentSaveFile.ContentMap.BodyFemaleNameMap.AddRange(CustomCostumes["body_flesh_female"].CustomObjects
            .Select(c => c.Item1));
        ...
        CustomContentSaveFile.ContentMap.ShapeNameMap[2]
        ...
        CustomContentSaveFile.ContentMap.FaceFemaleNameMap.AddRange(CustomCostumes["face_female"].CustomObjects
            .Select(c => c.Item1));
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[3]
        ...
        CustomContentSaveFile.ContentMap.ShapeNameMap[3]
        ...
        for (GameTextures.AAIJMJLPAFC = 4; GameTextures.AAIJMJLPAFC <= 7; GameTextures.AAIJMJLPAFC++)
        {
            ...
            CustomContentSaveFile.ContentMap.MaterialNameMap[GameTextures.AAIJMJLPAFC]
                .AddRange(CustomCostumes["face_male"].CustomObjects.Select(c => c.Item1));
            ...
            CustomContentSaveFile.ContentMap.ShapeNameMap[GameTextures.AAIJMJLPAFC]
                .AddRange(CustomCostumes["face_shape"].CustomObjects.Select(c => c.Item1));
        }
        ...
        for (GameTextures.AAIJMJLPAFC = 8; GameTextures.AAIJMJLPAFC <= 12; GameTextures.AAIJMJLPAFC++)
        {
            if (GameTextures.AAIJMJLPAFC != 10)
            {
                ...
                CustomContentSaveFile.ContentMap.FleshNameMap[GameTextures.AAIJMJLPAFC]
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[10]
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[13]
            .AddRange(CustomCostumes["arms_glove"].CustomObjects.Select(c => c.Item1));
        ...
        CustomContentSaveFile.ContentMap.SpecialFootwearNameMap.AddRange(CustomCostumes["legs_footwear_special"]
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[14]
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[15]
            .AddRange(CustomCostumes["legs_footwear"].CustomObjects.Select(c => c.Item1));
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[16]
        ...
        CustomContentSaveFile.ContentMap.TransparentHairMaterialNameMap.AddRange(
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[17]
        ...
        CustomContentSaveFile.ContentMap.ShapeNameMap[17]
        ...
        CustomContentSaveFile.ContentMap.TransparentHairHairstyleNameMap.AddRange(
        ...
        CustomContentSaveFile.ContentMap.ShapeNameMap[18]
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[19]
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[20]
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[21]
        ...
        CustomContentSaveFile.ContentMap.KneepadNameMap.AddRange(CustomCostumes["legs_kneepad"].CustomObjects
            .Select(c => c.Item1));
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[25]
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[26]
            .AddRange(CustomCostumes["legs_pattern"].CustomObjects.Select(c => c.Item1));
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[27]
        ...
        CustomContentSaveFile.ContentMap.ShapeNameMap[28]
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[29]
        ...
        CustomContentSaveFile.ContentMap.MaterialNameMap[30]
        ...
        CustomContentSaveFile.ContentMap.ShapeNameMap[31]
            .AddRange(CustomCostumes["face_headwear"].CustomObjects.Select(c => c.Item1));
        GameTextures.CEJEFCFAEOB[32] += CustomCostumes["arms_elbow_pad"].Count;
        CustomContentSaveFile.ContentMap.MaterialNameMap[32]
            .AddRange(CustomCostumes["arms_elbow_pad"].CustomObjects.Select(c => c.Item1));
        GameTextures.CEJEFCFAEOB[33] += CustomCostumes["arms_wristband"].Count;
        CustomContentSaveFile.ContentMap.MaterialNameMap[33]
            .AddRange(CustomCostumes["arms_wristband"].CustomObjects.Select(c => c.Item1));
